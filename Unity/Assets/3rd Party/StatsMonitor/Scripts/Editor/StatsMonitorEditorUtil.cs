...
// 
// StatsMonitorEditorUtil.cs - version 1.0.0 - Updated 01-02-2016 16:49
//  
...
{
	internal sealed class StatsMonitorEditorUtil
	{
		// ----------------------------------------------------------------------------
		// Public Methods
		// ----------------------------------------------------------------------------

		internal static bool PropertyChanged(SerializedProperty property)
		{
			return PropertyChanged(property, null);
		}

		internal static bool PropertyChanged(SerializedProperty property, GUIContent content, params GUILayoutOption[] options)
		{
		...
		internal static bool ToggleFoldout(SerializedProperty foldout, string caption, SerializedProperty toggle)
		{
			bool changed = false;
		...
		internal static bool Foldout(SerializedProperty foldout, string caption)
		{
			Rect fRect = EditorGUILayout.BeginHorizontal();
			fRect.xMin += 11;
			foldout.boolValue = EditorGUI.Foldout(fRect, foldout.boolValue, caption, true);
