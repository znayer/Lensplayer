...
public class JsonHelper
{
    ...
    public static string GetJsonValue(string jsonString, string handle)
    {
        ...
        if (match.Success)
        {
            ...
            int endIdx = jsonString.IndexOf("\"", startOfObj);
            return jsonString.Substring(startOfObj, endIdx - startOfObj);
        }
